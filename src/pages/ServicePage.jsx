...
/>
            <a href="/free" className="text-blue-500 hover:underline mt-2 block">
            <p>
...
/>
            <a href="/basic" className="text-blue-500 hover:underline mt-2 block">
              <p>
                <span>World Cities Database </span><br />
...
/>        
            <a href="/premium" className="text-blue-500 hover:underline mt-2 block">
              <p>
                <span>World Cities Database </span><br />
...
/>        
            <a href="/gold" className="text-blue-500 hover:underline mt-2 block">
              <p>
                <span>World Cities Database </span><br />
...
/>
            <a href="/platinum" className="text-blue-500 hover:underline mt-2 block">
              <p>
                <span>World Cities Database</span><br />
...
/>
            <a href="/titanium" className="text-blue-500 hover:underline mt-2 block">
            <p>
                <span>World Cities Database</span><br />
          ...
          <div className="product_images text-center">
            ...
            />
            <a href="/major-cities" className="text-blue-500 hover:underline mt-2 block ">
            <p>
          ...
          <div className="product_images text-center">
            <img
              ...
              className="w-[180px] h-[210px]"
            />
            <a href="/location-service" className="text-blue-500 hover:underline mt-2 block">
              <p>
